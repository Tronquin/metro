...
Metro.Repo.insert!(%Author{
  ...
  books: [
    %Book{
      ...
      pages: 613,
      image:
        "https://contentcafe2.btol.com/ContentCafe/Jacket.aspx?&userID=CLOH21163&password=CC44366&Value=9780679446699&content=M&Return=1&Type=M"
    },
    %Book{
      isbn: 9_780_307_593_313,
      title: "1Q84",
      year: 2011,
      summary:
      ...
      pages: 925,
      image:
        "https://contentcafe2.btol.com/ContentCafe/Jacket.aspx?&userID=CLOH21163&password=CC44366&Value=9780307593313&content=M&Return=1&Type=M"
    },
    %Book{
      isbn: 9_780_525_520_047,
      ...
      pages: 681,
      image:
        "https://contentcafe2.btol.com/ContentCafe/Jacket.aspx?&userID=CLOH21163&password=CC44366&Value=9780525520047&content=M&Return=1&Type=M"
    },
    %Book{
      isbn: 9_780_385_352_123,
      title: "Wind/Pinball",
      year: 2015,
      summary:
      ...
      pages: 233,
      image:
        "https://contentcafe2.btol.com/ContentCafe/Jacket.aspx?&userID=CLOH21163&password=CC44366&Value=9780385352123&content=M&Return=1&Type=M"
    },
    %Book{
      isbn: 9_781_400_043_668,
      ...
      pages: 467,
      image:
        "https://contentcafe2.btol.com/ContentCafe/Jacket.aspx?&userID=CLOH21163&password=CC44366&Value=9781400043668&content=M&Return=1&Type=M"
    },
    %Book{
      isbn: 9_780_375_704_024,
      ...
      pages: 296,
      image:
        "https://contentcafe2.btol.com/ContentCafe/Jacket.aspx?&userID=CLOH21163&password=CC44366&Value=9780375704024&content=M&Return=1&Type=M"
    },
    %Book{
      isbn: 9_780_385_352_109,
      title: "Colorless Tsukuru Tazaki and His Years of Pilgrimage",
      year: 2014,
      summary:
        "Haruki Murakami gives us the remarkable story of Tsukuru Tazaki, a young man haunted by a great loss; of dreams and nightmares that have unintended consequences for the world around us; and of a journey into the past that is necessary to mend the present. It is a story of love, friendship, and heartbreak for the ages.",
      pages: 386,
      image:
        "https://contentcafe2.btol.com/ContentCafe/Jacket.aspx?&userID=CLOH21163&password=CC44366&Value=9780385352109&content=M&Return=1&Type=M"
    },
    %Book{
      isbn: 9_780_375_411_694,
      ...
      pages: 210,
      image:
        "https://contentcafe2.btol.com/ContentCafe/Jacket.aspx?&userID=CLOH21163&password=CC44366&Value=9780375411694&content=M&Return=1&Type=M"
    },
    %Book{
      isbn: 9_780_375_402_517,
      ...
      pages: 213,
      image:
        "https://contentcafe2.btol.com/ContentCafe/Jacket.aspx?&userID=CLOH21163&password=CC44366&Value=9780375402517&content=M&Return=1&Type=M"
    },
    %Book{
      isbn: 9_780_307_265_838,
      title: "After Dark",
      year: 2007,
      summary:
      ...
      pages: 191,
      image:
        "https://contentcafe2.btol.com/ContentCafe/Jacket.aspx?&userID=CLOH21163&password=CC44366&Value=9780307265838&content=M&Return=1&Type=M"
    },
    %Book{
      isbn: 9_780_451_494_627,
      title: "Men Without Women",
      year: 2017,
      summary:
        "A new collection of short stories--the first major new work of fiction from the beloved, internationally acclaimed, Haruki Murakami since his #1 best-selling Colorless Tsukuru Tazaki and His Years of Pilgrimage. Across seven tales, Haruki Murakami brings his powers of observation to bear on the lives of men who, in their own ways, find themselves alone. Here are vanishing cats and smoky bars, lonely hearts and mysterious women, baseball and the Beatles, woven together to tell stories that speak to us all",
      pages: 227,
      image:
        "https://contentcafe2.btol.com/ContentCafe/Jacket.aspx?&userID=CLOH21163&password=CC44366&Value=9780451494627&content=M&Return=1&Type=M"
    }
  ]
})

genres =
  Metro.Repo.all(from(g in Genre, where: g.id in [13, 1, 5]))
  |> Metro.Repo.preload(:books)

books =
  from(b in Book, where: b.author_id == 1)
  |> Metro.Repo.all()
...
Metro.Repo.insert!(%Author{
  ...
  books: [
    %Book{
      ...
      pages: 509,
      image:
        "https://contentcafe2.btol.com/ContentCafe/Jacket.aspx?&userID=CLOH21163&password=CC44366&Value=9780375826689&content=M&Return=1&Type=M"
    },
    %Book{
      isbn: 9_780_375_826_702,
      title: "Eldest",
      year: 2005,
      summary:
      ...
      pages: 681,
      image:
        "https://contentcafe2.btol.com/ContentCafe/Jacket.aspx?&userID=CLOH21163&password=CC44366&Value=9780375826702&content=M&Return=1&Type=M"
    },
    %Book{
      isbn: 9_780_375_926_723,
      title: "Brisingr",
      year: 2008,
      summary:
      ...
      pages: 762,
      image:
        "https://contentcafe2.btol.com/ContentCafe/Jacket.aspx?&userID=CLOH21163&password=CC44366&Value=9780375926723&content=M&Return=1&Type=M"
    },
    %Book{
      isbn: 9_780_375_856_112,
      title: "Inheritance",
      year: 2011,
      summary:
        "The young Dragon Rider Eragon must finally confront the evil king Galbatorix to free Alaga©±sia from his rule once and for all. Conclusion to the series.",
      pages: 860,
      image:
        "https://contentcafe2.btol.com/ContentCafe/Jacket.aspx?&userID=CLOH21163&password=CC44366&Value=9780375856112&content=M&Return=1&Type=M"
    }
  ]
})

genres =
  Metro.Repo.all(from(g in Genre, where: g.id in [27, 4, 5, 20, 7]))
  |> Metro.Repo.preload(:books)

books =
  from(b in Book, where: b.author_id == 2)
  |> Metro.Repo.all()
  |> Metro.Repo.preload(:genres)
...
Metro.Repo.insert!(%Library{
  ...
  copies: [
    %Copy{
      isbn_id: 9_780_679_446_699,
      checked_out?: false
    },
    %Copy{
      isbn_id: 9_780_307_593_313,
      checked_out?: false
    },
    %Copy{
      isbn_id: 9_780_451_494_627,
      checked_out?: false
    }
  ],
  rooms: [
    %Room{
      ...
      events: [
        %Event{
          ...
          images:
            "https://www.columbuslibrary.org/sites/default/files/uploads/images/SRC-SignUpNowTile.jpg"
        }
      ]
    },
    %Room{
      ...
      events: [
        %Event{
          ...
          description:
            "Columbus Metropolitan Library is committed to building a new, world-class library in Dublin.",
          images:
            "https://www.columbuslibrary.org/sites/default/files/uploads/images/DublinCampaign_homepage.jpg"
        }
      ]
    },
    %Room{
      ...
      events: [
        %Event{
          ...
          description: "Read over the summer for strong reading skills all year long.",
          images:
            "https://www.columbuslibrary.org/sites/default/files/uploads/images/MayQuickPickEbooks.jpg"
        }
      ]
    }
  ]
...
Metro.Repo.insert!(%Library{
  ...
  copies: [
    %Copy{
      isbn_id: 9_780_375_856_112,
      checked_out?: false
    },
    %Copy{
      isbn_id: 9_780_525_520_047,
      checked_out?: false
    },
    %Copy{
      isbn_id: 9_780_385_352_123,
      checked_out?: false
    },
    %Copy{
      isbn_id: 9_781_400_043_668,
      checked_out?: false
    },
    %Copy{
      isbn_id: 9_780_375_704_024,
      checked_out?: false
    },
    %Copy{
      isbn_id: 9_780_385_352_109,
      checked_out?: false
    },
    %Copy{
      isbn_id: 9_780_375_411_694,
      checked_out?: false
    },
    %Copy{
      isbn_id: 9_780_375_402_517,
      checked_out?: false
    },
    %Copy{
      isbn_id: 9_780_307_265_838,
      checked_out?: false
    }
  ],
  rooms: [
    %Room{
      ...
      events: [
        %Event{
          ...
          images:
            "https://www.columbuslibrary.org/sites/default/files/uploads/images/crp%26l-109%20cropped%203.jpg"
        }
      ]
    }
  ]
...
Metro.Repo.insert!(%Library{
  ...
  image:
    "https://www.columbuslibrary.org/sites/default/files/uploads/images/WhitehallBranch_451x300px.jpg",
  hours: "Mon-Thur: 9 a.m. - 9 p.m.",
  branch: "Whitehall",
  copies: [
    %Copy{
      isbn_id: 9_780_375_926_723,
      checked_out?: false
    },
    %Copy{
      isbn_id: 9_780_375_826_702,
      checked_out?: false
    },
    %Copy{
      isbn_id: 9_780_375_826_689,
      checked_out?: false
    }
  ]
})

Metro.Repo.insert!(%User{
  name: "admin",
